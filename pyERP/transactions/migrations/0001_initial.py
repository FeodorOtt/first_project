# Generated by Django 2.1.4 on 2019-01-15 20:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_id', models.SmallIntegerField()),
                ('handle_time', models.DateTimeField(auto_now=True)),
                ('bankimport', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='transactions.Bankimport')),
                ('cr_account', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions_cr_account', to='transactions.Accounts')),
                ...
                ('db_account', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions_db_account', to='transactions.Accounts')),
                ...
                ('exchange_currency', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='transactions_exchange_currency', to='transactions.Currency')),
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='transactions.Transactions')),
                ('partition', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='transactions.Partitions')),
                ('pattern', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='transactions.TransactionPatterns')),
            ],
        ),
