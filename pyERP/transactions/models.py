...
class Transactions(models.Model):
    ...
    db_account = models.ForeignKey('Accounts', related_name='transactions_db_account', on_delete=models.PROTECT, null=True)
    cr_client = models.ForeignKey('Clients', related_name='transactions_cr_client', on_delete=models.PROTECT)
    cr_account = models.ForeignKey('Accounts', related_name='transactions_cr_account', on_delete=models.PROTECT, null=True)
    currency_rate = models.DecimalField(max_digits=15, decimal_places=10, null=True)
    exchange_income = models.DecimalField(max_digits=15, decimal_places=2, null=True)
    ...
    exchange_amount = models.DecimalField(max_digits=15, decimal_places=2, null=True)
    exchange_amount_e = models.DecimalField(max_digits=15, decimal_places=2, null=True)
    currency = models.ForeignKey('Currency', related_name='transactions_currency', on_delete=models.PROTECT)
    exchange_currency = models.ForeignKey('Currency', related_name='transactions_exchange_currency', on_delete=models.PROTECT, null=True)
    payment_details = models.CharField(max_length=1000, blank=True, null=True)
    addinfo = models.CharField(max_length=200, blank=True, null=True)
    bankimport = models.ForeignKey('Bankimport', on_delete=models.SET_NULL, null=True)
    status_id = models.SmallIntegerField()
    user = models.ForeignKey('Users', on_delete=models.PROTECT)
    handle_time = models.DateTimeField(auto_now=True)
