...
from funds.resources import CurrencyResource, ClientResource, TransactionResource, UserResource, PartitionResource, ClientCategoryResource, \
                            ClientTypeLocaleResource, ClientTypeResource, BankResource, CountryResource
